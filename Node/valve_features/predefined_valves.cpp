...
StaticJsonDocument<200> predefinedValvesDoc;

void setup_predefined_valves(){
  predefinedValvesArray = predefinedValvesDoc.createNestedObject("predefinedValvesArray");
  predefinedValvesArray_valve0 = predefinedValvesArray.createNestedArray("valve0");
  predefinedValvesArray_valve0.add(5000);
  // predefinedValvesArray = predefinedValvesDoc.to<JsonArray>();
  // JsonObject valve0 = predefinedValvesArray.createNestedObject();
  // valve0["id"] = 0;
  ...
  // JsonObject valve1 = predefinedValvesArray.createNestedObject();
  // valve1["id"] = 1;
  ...
  // JsonObject valve2 = predefinedValvesArray.createNestedObject();
  // valve2["id"] = 2;
  ...
  // JsonObject valve3 = predefinedValvesArray.createNestedObject();
  // valve3["id"] = 3;
  ...
  // JsonObject valve4 = predefinedValvesArray.createNestedObject();
  // valve4["id"] = 3;
